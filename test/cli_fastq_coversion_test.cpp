...
{
    app_test_result const result = execute_app("counter", data("in.fastq"));
...
{
    app_test_result const result = execute_app("counter", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("counter", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("counter", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("counter", data("in.fastq"), "-o", "does_not_exist/out.fasta");
