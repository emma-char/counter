...
# counter [![build status][1]][2] [![codecov][3]][4]
<!--
...
<!--
    This is the CI badge image:
        ...
        `/emma-char/counter/` - owner/repository
        `CI%20on%20Linux` - name of the workflow as encoded URL (e.g., whitespace = %20)
        `main` - branch to show
        `?style=flat&logo=github` - use a GitHub-style badge
        `&label=counter%20CI` - text on the badge
        `"Open GitHub actions page"` - this text will be shown on hover
-->
[1]: https://img.shields.io/github/actions/workflow/status/emma-char/counter/ci_linux.yml?branch=main&style=flat&logo=github&label=counter%20CI "Open GitHub actions page"
<!--
    This is the CI badge link:
        `https://github.com/emma-char/counter/actions` - actions page of owner/repository
        `?query=branch%3Amain` - only show actions that ran on the mater branch
-->
[2]: https://github.com/emma-char/counter/actions?query=branch%3Amain
<!--
    This is the Codecov badge image:
        Codecov offers badges: https://app.codecov.io/gh/emma-char/counter/settings/badge
        While being logged in into Codecov, navigate to Settings->Badge and copy the markdown badge.
        Copy the image part of the markdown badge here.
    `"Open Codecov page"` - this text will be shown on hover
-->
[3]: https://codecov.io/gh/emma-char/counter/branch/main/graph/badge.svg "Open Codecov page"
<!--
...
-->
[4]: https://codecov.io/gh/emma-char/counter
...
3. **Clone** your repository locally: `git clone git@github.com:emma-char/counter.git`
4. <details><summary>Build and test the app (example) </summary>
    ...
    make               # build the app counter
    make check         # build and run tests
    ./bin/counter # Execute the app (prints a short help page)
    ```
   </details>

## Setting up Codecov (optional)

1. Go to https://codecov.io/gh/emma-char/counter.
2. Sign in with your GitHub account.
3. Go to https://app.codecov.io/gh/emma-char/counter/config/general.<br>
   If the repository cannot be found, go to https://app.codecov.io/gh/emma-char and click `Resync`.<br>
   Then try again.
4. Copy the `Repository Upload Token`.
5. Go to https://github.com/emma-char/counter/settings/secrets/actions.
...
1. Go to https://github.com/emma-char/counter/settings/actions.
...
3. You can go to https://github.com/emma-char/counter/actions/workflows/lint.yml and click `Run workflow` to run linting.
...
2. Add the following lines at the bottom of `src/CMakeLists.txt`
    ...
    target_link_libraries (tutorial01 PRIVATE "counter_lib")
    ```
